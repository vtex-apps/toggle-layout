📢 Use this project, [contribute](https://github.com/vtex-apps/toggle-layout) to it or open issues to help evolve it using [Store Discussion](https://github.com/vtex-apps/store-discussion).
